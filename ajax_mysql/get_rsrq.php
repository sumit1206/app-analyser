...
//    $op = isset($_POST['op']) ? "lower(SPN) = '".strtolower($_POST['op'])."'" : '';
    ...
    $sql_rsrq = "select LAT lat, LON lng,RSRQ rsrp FROM black_box_datas WHERE LAT REGEXP '[0-9]' and LON REGEXP '[0-9]' and RSRQ REGEXP '[0-9]' and $op $os $ts and $total_calls_bb_ids_cond limit 10000";
