                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered nowrap">
                                ...
                                <tr>
                                    ...
                                    <td class="">-</td>
                                    <td id="mcr_mute_calls_uplink">-</td>
                                    <td id="mcr_min_sec_uplink">-</td>
                                    <td id="mcr_max_sec_uplink">-</td>
                                    <td id="mcr_avg_sec_uplink">-</td>
                                </tr>
                                <tr>
                                    <td>Downlink</td>
                                    <td class="mcr_total_calls">0</td>
...
<!--                            <table class="col-md-12">-->
                            <table class="table table-striped table-bordered nowrap">
                                ...
                                <tr>
                                    ...
                                    <td id="mute_duration_min_uplink">-</td>
                                    <td id="mute_duration_max_uplink">-</td>
                                    <td id="mute_duration_avg_uplink">-</td>
                                </tr>
                                <tr>
                                    <td>Downlink</td>
