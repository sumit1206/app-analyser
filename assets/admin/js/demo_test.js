...
//        toggleMarkersGroup();
    ...
    $.ajax({
        type:'POST',
        url:'ajax/save_frm_data_test.php',
...
//            jQuery('#txt_city').find("option:eq(0)").html("Please wait..");
    ...
    $('#btn_chart').on('click',function(){
        ...
        $.ajax({
            type:'POST',
            url:'ajax/get_map_details_test.php',
        ...
        $.ajax({
            ...
            success:function(res) {
                ...
                if(rsrp_locations_total_count > 1) {
                    var marker_point;
                    var rsrp_locations = [[], [], [], [], []];
...
//                    toggleMarkersGroup();
    ...
    $('#btn_export').on('click',function(){
        ...
        var form = $('<form name="export_form" method="post" action="ajax/save_frm_data_test.php"></form>');        
