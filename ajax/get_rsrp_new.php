...
//    $op = isset($_POST['op']) ? "lower(SPN) = '".strtolower($_POST['op'])."'" : '';
    ...
    $sql_rsrp = "select lat, lon, rsrp FROM rf_details WHERE lat is not null and lat > 0 and lon is not null and lon > 0 and rsrp is not null and $op $os $ts and $total_calls_bb_ids_cond";
